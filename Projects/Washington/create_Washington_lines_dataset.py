...
def create_char_list_file(char_list_file_path, transcriptions_file_path, log_file_indicator):
    try:
        ...
        try:
            ...
            print('File does not exist: ', transcriptions_file)
            log_file_indicator.write('\n Exception: File does not exist: '+str(transcriptions_file_path)+'\n')
            log_file_indicator.close()
            sys.exit([1])
        else:
...
#        print(selected_transcriptionLenList)
